      ...
      /**
       * axis2_stub_Searcher C implementation
       */
                                      ...
                                      const axis2_char_t *endpoint_uri)
      {
         ...
         {
            endpoint_uri = axis2_stub_get_endpoint_uri_of_Searcher(env);
         }
         ...
         axis2_stub_populate_services_for_Searcher(stub, env);
         return stub;
      }
      ...
      axis2_stub_populate_services_for_Searcher(axis2_stub_t *stub, const axutil_env_t *env)
      {
         ...
         svc_qname = axutil_qname_create(env,"Searcher" ,NULL, NULL);
      ...
      axis2_stub_get_endpoint_uri_of_Searcher( const axutil_env_t *env )
      {
        ...
        /* set the address from here */
              ...
              endpoint_uri = "http://localhost:8080/axis2/services/Searcher";
        ...
        return endpoint_uri;
                                               ...
                                               adb_searchserve_t* _searchserve10)
         {
            ...
            adb_searchserveResponse_t* ret_val;
            
                                payload = adb_searchserve_serialize(_searchserve10, env, NULL, NULL, AXIS2_TRUE, NULL, NULL);
            ...
            if (NULL == options)
            {
                ...
                return (adb_searchserveResponse_t*)NULL;
            }
            soap_act = axis2_options_get_soap_action( options, env );
            if (NULL == soap_act)
            {
              is_soap_act_set = AXIS2_FALSE;
              soap_action = "urn:searchserve";
              soap_act = axutil_string_create(env, "urn:searchserve");
            ...
            if(soap_act)
            {
              axutil_string_free(soap_act, env);
                    ...
                    ret_val = adb_searchserveResponse_create(env);

                    if(adb_searchserveResponse_deserialize(ret_val, env, &ret_node, NULL, AXIS2_FALSE ) == AXIS2_FAILURE)
                    {
                        if(ret_val != NULL)
                        {
                            adb_searchserveResponse_free(ret_val, env);
                        }

                        AXIS2_LOG_ERROR( env->log, AXIS2_LOG_SI, "NULL returnted from the adb_searchserveResponse_deserialize: "
        ...
        struct axis2_stub_Searcher_searchserve_callback_data
        {   
            void *data;
        ...
        static axis2_status_t AXIS2_CALL axis2_stub_on_error_Searcher_searchserve(axis2_callback_t *callback, const axutil_env_t *env, int exception)
        {
            axis2_status_t ( AXIS2_CALL *on_error ) (const axutil_env_t *, int, void *data);
            struct axis2_stub_Searcher_searchserve_callback_data* callback_data = NULL;

            void *user_data = NULL;

            axis2_status_t status;
        
            callback_data = (struct axis2_stub_Searcher_searchserve_callback_data*)axis2_callback_get_data(callback);
        ...
        axis2_status_t AXIS2_CALL axis2_stub_on_complete_Searcher_searchserve(axis2_callback_t *callback, const axutil_env_t *env)
        {
            axis2_status_t ( AXIS2_CALL *on_complete ) (const axutil_env_t *, adb_searchserveResponse_t* _searchserveResponse11, void *data);
            struct axis2_stub_Searcher_searchserve_callback_data* callback_data = NULL;
            void *user_data = NULL;
        ...
        /**
                                                  ...
                                                  axis2_status_t ( AXIS2_CALL *on_error ) (const axutil_env_t *, int exception, void *data) )
         {
            ...
            struct axis2_stub_Searcher_searchserve_callback_data *callback_data;

            callback_data = (struct axis2_stub_Searcher_searchserve_callback_data*) AXIS2_MALLOC(env->allocator, 
                                    sizeof(struct axis2_stub_Searcher_searchserve_callback_data));
            ...
            axis2_callback_set_on_complete(callback, axis2_stub_on_complete_Searcher_searchserve);
            /* Set our on_error function pointer to the callback object */
            axis2_callback_set_on_error(callback, axis2_stub_on_error_Searcher_searchserve);
